    ...
    $('#button_search').click(function() {
        ...
        if (text_search == "") {
            ...
            $.ajax({
                ...
                type: 'post',
                data: { text_search: text_search, Search_by: Search_by },
                    ...
                    if (data.success == false) {
                        ...
                        $.each(data, function(key, MAINPART) {
                            rows +=
                                ...
                                "<td>" + MAINPART.D1 + "</td>" +
                                "<td><button class='btn btn-success' type='button' id='selectdd' D1='" + MAINPART.D1 + "' D2='" + MAINPART.D2 + "' ND='" + MAINPART.ND + "' PARTID='" + MAINPART.PARTID + "'><i class='fa fa-check' aria-hidden='true'></i></button></td>" +
                                "</tr>";
                        });
